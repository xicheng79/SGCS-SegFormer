...
data_root = 'mydata/greenland_ndvi_3968x3968_test'
img_norm_cfg = dict(
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='TensorboardLoggerHook',  # 新增TensorBoard日志
...
work_dir = 'work_dirs/513segformer_mit-b3_512x512_160k_mygreenland'
gpu_ids = [0]
auto_resume = False